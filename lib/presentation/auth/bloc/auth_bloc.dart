...
import 'package:scribe/presentation/auth/bloc/auth_event.dart';
import 'package:scribe/presentation/auth/bloc/auth_state.dart';
        ...
        if (userCred.user != null) {
          ...
          if(token != null){
            ...
            if(role.isEmpty){
              ...
              firebaseMessaging.subscribeToTopic("scribe_${userCred.user!.phoneNumber!.substring(1)}");
