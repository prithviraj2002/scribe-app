...
import 'package:scribe/presentation/profile/view/personal_detail_view.dart';
    ...
    return Scaffold(
      ...
      body: BlocConsumer<ProfileBloc, ProfileState>(
            ...
            if(state is ScribeDataState){
              return Column(
                ...
                children: [
                  ...
                  Text(state.scribe.name, style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold),),
                  const SizedBox(height: 4,),
                  Text(state.scribe.email, style: TextStyle(color: Colors.grey, fontSize: 16),),
                  const SizedBox(height: 20,),
                  const Divider(),
                  const SizedBox(height: 20,),
                  ListTile(
              ...
              return Center(child: Text("Couldn't get scribe data!"));
            }
            else if(state is ScribeDataLoadingState){
          ...
          listener: (BuildContext ctx, ProfileState state){
            if(state is ScribeDataErrorState){
